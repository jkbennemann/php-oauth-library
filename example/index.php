...
$httpClient = new \Jkbennemann\HttpClient\Curl();
 ...
 * a new instance of \Jkbennemann\Auth\CollectionFactory
 * you can use custom or register another providers by CollectionFactory instance
 */
$collectionFactory = null;

$service = new \Jkbennemann\Auth\Service(
    new \Jkbennemann\Common\HttpStack(
        $httpClient,
        new \Jkbennemann\HttpClient\RequestFactory(),
        new \Jkbennemann\HttpClient\StreamFactory()
    ),
    new \Jkbennemann\Provider\Session\Session(),
    $configureProviders,
    $collectionFactory
);
