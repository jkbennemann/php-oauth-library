...
use Jkbennemann\OAuth2\Exception\InvalidState;
use Jkbennemann\OAuth2\Exception\Unauthorized;
use Jkbennemann\OAuth2\Exception\UnknownAuthorization;
use Jkbennemann\OAuth2\Exception\UnknownState;
...
class SmashCast extends \Jkbennemann\OAuth2\AbstractProvider
{
