...
use Jkbennemann\Provider\Exception\InvalidRequest;
...
abstract class AbstractBaseProvider
{
     ...
     * @throws \Jkbennemann\Provider\Exception\InvalidResponse
     */
    ...
    /**
     * @return \Jkbennemann\Provider\Consumer
     */
    ...
    protected function createRequest(string $method, string $uri, array $query, array $headers, array $payload = null): RequestInterface
    {
        ...
        if (!$request->hasHeader('User-Agent')) {
            $request = $request->withHeader(
                'User-Agent',
                'Jkbennemann\Auth (https://github.com/SocialConnect/auth) v3'
            );
        }
