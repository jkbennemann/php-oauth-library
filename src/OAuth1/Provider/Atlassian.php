...
use Jkbennemann\OAuth1\Signature\MethodRSASHA1;
...
class Atlassian extends AbstractProvider
{
     ...
     * @param \Jkbennemann\Provider\Session\SessionInterface $session
     * @param array $parameters
     * @throws \Jkbennemann\Provider\Exception\InvalidProviderConfiguration
     */
