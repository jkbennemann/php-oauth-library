...
namespace Jkbennemann\OAuth1;

use Psr\Http\Message\ResponseInterface;
use Jkbennemann\Common\Exception\Unsupported;
use Jkbennemann\Common\HttpStack;
use Jkbennemann\OAuth1\Exception\Unauthorized;
use Jkbennemann\OAuth1\Exception\UnknownAuthorization;
use Jkbennemann\OAuth1\Signature\AbstractSignatureMethod;
...
use Jkbennemann\OAuth1\Exception\InvalidRequestToken;
...
abstract class AbstractProvider extends AbstractBaseProvider
{
    ...
    /**
     * @return \Jkbennemann\OAuth1\Token
     */
